...
class WorldStateID:
    ...
    Direct caller instantiation with authorized_constraints or authorized_resolutions is prohibited; obtain an authorized world state via WorldStateAuthority.
    """
        ...
        **kwargs: Any,
        ...
        if authorized_constraints or authorized_resolutions or kwargs:
            raise PermissionError(
                "Direct construction of WorldStateID with authorized_constraints or authorized_resolutions is prohibited; obtain an authorized world state via WorldStateAuthority."
            )
    ...
    def create_authorized_state(cls, *args: Any, **kwargs: Any) -> "WorldStateID":
        ...
        raise PermissionError(
            "Direct invocation of WorldStateID.create_authorized_state is prohibited; obtain an authorized world state via WorldStateAuthority."
        )
